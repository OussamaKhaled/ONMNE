    ...
    <div id="wrapper">
        ...
        <div id="page-wrapper">
            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <h1 class="page-header">
                            <small>Ajouter Pharmacien</small>
                        </h1>
             ...
             <div class="col-lg-12">
                  <h2>Ajouter Pharmacien</h2>
                      <div class="col-lg-6">

                        <form role="form" method="post" action="addphar.php?action=ajouterlabo">
                          <table width="393" border="0">
  <tbody>
    <tr>
      <td width="156" height="33">Pharmacien</td>
