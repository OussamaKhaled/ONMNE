                ...
                <div class="row">
                    <div class="col-lg-12">
                        <h1 class="page-header">
                            <small>Fiche de liaision du patient Médecin-Pharmacien</small>
                        </h1>
...
$pass = '';
$db = mysqli_connect ($hote, $user, $pass,$base) or die (mysqli_error ());
         $dd_res=mysqli_query($db,"SELECT * FROM traitement where  pour='Pharmacien'");
...
if($_SERVER['REQUEST_METHOD'] == "POST")
  {
         ...
         { 
	          $query2 = "SELECT * FROM traitement where codepa= '$des' and pour='Pharmacien'";
