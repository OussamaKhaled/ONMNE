             ...
             <div class="col-lg-12">
                <?php
					...
					switch($_GET['action']){
						...
						mysqli_query($db,"INSERT INTO `traitement` (`codepa`, `traitement`, `duree`, `schem`, `pour`, `datee`, `nommed`, `telmed`) VALUES  ('".$codepa."', '".$traitement."', '".$duree."', '".$schem."', '".$pour."', '".$datee."', '".$_SESSION['nom']."', '".$_SESSION['tel']."')");	
