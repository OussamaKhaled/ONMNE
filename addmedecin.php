             ...
             <div class="col-lg-12">
                <?php
					...
					switch($_GET['action']){
						...
						mysqli_query($db,"INSERT INTO `medecin` (`nom`, `tel`, `mail`, `fax`, `secteur`, `hopital`, `service`, `type`, `login`, `mp`) VALUES  ('".$nom."', '".$tel."', '".$mail."', '".$fax."', '".$secteur."', '".$hopital."', '".$service."', '".$type."', '".$login."', '".$mp."')");	
