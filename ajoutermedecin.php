...
<body>
             ...
             <div class="col-lg-12">
                  <h2>Ajouter un Médecin</h2>
                      <div class="col-lg-6">
                        ...
                        <form role="form" method="post" action="addmedecin.php?action=ajoutermedecin">
  ...
  <tbody>
    ...
    <tr>
      ...
      <td><select name="secteur" id="secteur">
    ...
    <tr>
      ...
      <td><input name="hopital" type="text" id="hopital"></td>
    </tr>
    <tr>
