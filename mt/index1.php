    ...
    <div id="wrapper">
        ...
        <div id="page-wrapper">
            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <h1 class="page-header">
                            <small>Mise à jour Patients </small>
                        </h1>
             ...
             <div class="col-lg-12">
                        <h2>List Patients</h2> <a href="ajouterpatient.php?action=ajouterpatient" type="button" class="btn btn-xs btn-info">Ajouter Patient </a>
                ...
                $query = 'SELECT * FROM patient ';
                    $result = mysqli_query($db,$query) or die (mysql_error($db));
                        ...
                        while ( $row = mysqli_fetch_assoc($result)) {
                           ...
                           echo '<td> <a  type="button" class="btn btn-xs btn-warning" href="editpatient.php?action=edit & id='.$row['crf'] . '"> Modifier </a> ';
                            echo ' <a  type="button" class="btn btn-xs btn-danger" href="delpatient.php?type=patient&delete & id='. $row['crf'] . '">Supprimer </a> </td>';
                            echo '</tr> ';
                }
            ?> 
