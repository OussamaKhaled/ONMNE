...
<div id="main_container">
  ...
  <div id="main_content">
    ...
    <div class="style1">
      <div class="style2">INSERER DE NOUVEAUX PRODUITS ICI</div>
      <div class="prod_box_big">
        ...
        <div class="center_prod_box_big">
          ...
          <div class="style3">
             ...
             <div class="form_row">
              <label class="contact"><strong>Nom de Product :</strong></label>
    ...
    $cat_id = $row_cats['cat_id'];
     ...
     echo "<option value=$cat_id>$cat_tit</option>";    
           ...
           ?>
            ...
            <div class="form_row">
              <label class="contact"><strong>Marque de produit:</strong></label>
            ...
            <div class="form_row">
              <label class="contact"><strong>Image de Produit:</strong></label>
            ...
            <div class="form_row">
              <label class="contact"><strong>Keywords Produit:</strong></label>
  ...
  <div class="footer">
    ...
    <div class="center_footer"> &nbsp;All Rights Reserved Ichraf 2019<br />
      	<br />
    </div>
  </div>
</div>
...
if(isset($_POST['index'])){
   ...
   echo"<script>alert('Le produit a été inséré')</script>";
